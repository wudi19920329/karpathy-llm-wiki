...
Workflows in this guide can be found in the [Workflow Templates](https://docs.comfy.org/interface/features/template). If you can’t find them in the template, your ComfyUI may be outdated. (Desktop version’s update will delay sometime)
...
To prompt multiple subjects separately, separate with commas and use `:N` to specify the max amount of objects detected per prompt: `eye:2, window panels:4`
